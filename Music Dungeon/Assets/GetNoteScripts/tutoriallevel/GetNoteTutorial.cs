...
public class GetNoteTutorial : MonoBehaviour
{
    ...
    void NoteandSwing(){
        ...
        if(Input.GetKeyDown("space")){
            GameObject.Find("player").GetComponent<tutorialmovement>().Swing(); 
        }
        */
    ...
    void GenerateNote(){
        targetNote = GameObject.Find("FarWall").GetComponent<tutorialsong>().GPnotes[index];
    }
