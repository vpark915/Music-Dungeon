...
public class GetNoteHard : MonoBehaviour
{
    ...
    void NoteandSwing(){
        ...
        if(Input.GetKeyDown("space")){
            GameObject.Find("knight").GetComponent<newcontrols>().Swing(); 
        }
        */
    ...
    void GenerateNote(){
        targetNote = GameObject.Find("GoblinLine").GetComponent<cancansong>().CANCANnotes[index];
    }
}
