...
public class GetNote1 : MonoBehaviour
{
    ...
    void NoteandSwing(){
        ...
        if(Input.GetKeyDown("space")){
            GameObject.Find("player").GetComponent<GPmovement>().Swing(); 
        }
        */
    ...
    void GenerateNote(){
        targetNote = GameObject.Find("Notes").GetComponent<gymnopedieno1>().GPnotes[index];
    }
