...
public class GetNote3 : MonoBehaviour
{
        ...
        */
        if(frequency == 1.47570235134f || frequency == 0f){
            ...
            if(CurrentNote == targetNote){
                GameObject.Find("player").GetComponent<PLmovement>().Swing(); 
            }
        }
    }

    void GenerateNote(){
        targetNote = GameObject.Find("Notes").GetComponent<Prelude>().PLnotes[index];
    }
